...
public abstract class ProvidedReplica extends ReplicaInfo {
  ...
  static InputStream createInputStream(ProvidedReplica replica,
      FSDataInputStream fsIns, String bpid, boolean readThough, long fileOffset,
      long seekOffset, Configuration conf) throws IOException {
    if (readThough) {
      ReadThroughInputStream readThroughIns = ReflectionUtils.newInstance(
          conf.getClass(DFSConfigKeys.DFS_DATANODE_PROVIDED_CACHE_TASK_CLASS,
